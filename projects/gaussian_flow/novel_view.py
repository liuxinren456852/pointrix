...
@torch.no_grad()
def test_view_render(render_func, datapipeline, output_path, device='cuda'):
    """
...
def novel_view_render(render_func, datapipeline, output_path, novel_view_list=["Dolly", "Zoom", "Spiral"], device='cuda'):
    """
