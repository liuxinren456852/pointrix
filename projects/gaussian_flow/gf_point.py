...
class GaussianFlowPointCloud(GaussianPointCloud):
    ...
    def fwd_flow(self, timestamp):
        ...
        self.feat_flow = self.features + feat_traj.unsqueeze(1)
    ...
    def get_shs_flow(self):
        return torch.cat([
            self.feat_flow, self.features_rest,
        ], dim=1)
